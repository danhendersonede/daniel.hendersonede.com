...
valueProposition: 'Led the creation of an industry standard, with 9,800+ Figma downloads and now adopted by organizations around the world.'
order: 4
---
...
/>
*Figure 1: Highlights of the some of the existing annotations workflows on Miro,
Confluence, and Sketch.*
...
/>
*Figure 2: Diagram of an arrow stamp and its anatomy, highlighting an icon, text
label, directional arrow, outline and shadow, and an optional reference number.*
...
/>
*Figure 3: A full set of arrow, lasso, and detail stamps for landmarks,
headings, links, notes, buttons, images, reading order, and focus order.*
...
/>
*Figure 4: Five nested lasso annotation stamps with outlines that all have
different dashed styles. It is difficult, at this level of complexity, to
...
/>
*Figure 5: A heading annotation stamp's heading level drop-down menu in Figma's
...
/>
*Figure 6: Two rows of four heading stamps. The top row has a capital H close to
the number of the heading level. The bottom row has a lowercase H isn't as close
to the number, making it easier to discern the level of heading.*
...
/>
*Figure 7: Two sets of four annotation stamps. The left set uses a 'touch
target' height of 44px. The right set uses a height of 32px and takes up 3/4 the
vertical space.*
...
/>
*Figure 8: An annotation legend for developers to understand the purpose and
format of each stamp.*
...
/>
*Figure 9: A Figma branch review comparing a filled out Details component in a
Before view and Latest view. One of the filled out properties has been
overridden by a component change.*
...
/>
*Figure 10: A grid of pin stamp, lasso stamp, and detail components for
landmarks, headings, focus order, links, inputs, reading order, notes, buttons,
and images.*
...
<iframe
  ...
  width="800"
  height="450"
  src="https://embed.figma.com/design/Y57MNMvaI8AbDyzidVPoxt/Web-Accessibility-Annotation-Kit-(Community)?node-id=2-670&embed-host=share"
  allowfullscreen
></iframe>
