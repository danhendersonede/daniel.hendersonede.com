...
pageTitle: 'Updating the CVS Health design system to conform with WCAG 2.2'
...
valueProposition: 'Scaled design system architecture enabling 400+ designers across enterprise products'
---
...
- Senior Accessibility Designer **_(me)_**
...
> <cite>
>   [CVS Health Tech
>   Blog](https://medium.com/cvs-health-tech-blog/the-path-to-wcag-2-2-conformance-through-our-design-system-59913a8bf876#:~:text=CVS%20customers%20approach,component%20relationships%20accessibly.)
> </cite>
...
/>
*Figure 1: A link focused within the Card component with the focus indicator not
being obscured by its container.*
...
/>
*Figure 2: A list of Link components with the focus indicator present and
visible above any surrounding content.*
...
/>
*Figure 3: The collection of Button components in their Default and Reversed
variants.*
...
/>
*Figure 4: The Tab component horizontally scrolls when content cannot fit within
the viewport.*
...
/>
*Figure 5: A comparison of the Figma and coded components for the Radio Button
component.*
...
/>
*Figure 6: The Password Input component is also built-in with a show/hide
functionality.*
